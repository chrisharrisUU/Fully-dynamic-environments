...
First, which strategy is most successful? We ran `r success_results$runs[1]` iterations of the simulation.
...
success_results %>%
  ...
  group_by(strategy) %>%
  top_n(3, success) %>%
  knitr::kable(caption = "Most successful window sizes") %>%
  kable_styling(bootstrap_options = "hover", full_width = F, position = "center")
```
...
success_results %>%
  ...
  knitr::kable(caption = "Most successful strategy") %>%
  kable_styling(bootstrap_options = "hover", full_width = F, position = "center")
```
